        ...
        <div class="popup_box">
            ...
            <div class="popup_form">
                ...
                <footer class="form_action">
                    ...
                    <button class="btn_green" @click="editLga">Submit</button>
                </footer>     
...
export default {
    ...
    methods : {
        async editLga(){
            ...
            try {
                const editLga = await axios.put(`https://v-guard.onrender.com/api/lgaAdmin/${this.lgaAdmin}`, fd, {headers : {"Authorization": "Token "+localStorage.getItem('token')}})
                this.$swal({
                    icon:'success',
                    title: 'Success',
